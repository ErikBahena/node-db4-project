...
if a steps ingredient doesn't have a specific quantity, quantity will be "varied", that way the client doesn't get back an object with no quantity key, or quantity as null, etc.
